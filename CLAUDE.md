...
69. **Confirm 5 launch decisions before W1 build start:** D-01 palette lock (current verdigris recommended), D-04 notification cadence (three independent toggles, default off), Q-01 OneSignal vs own push (OneSignal recommended), Q-04 guest mode (keep recommended), Q-06 icon design (CC first draft recommended). See KALLOS-v1-Launch-Plan.html Decisions section.
