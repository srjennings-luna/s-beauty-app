...
var br = {
  ...
  strokeOpacity: 1,
  strokeWidth: 1
}, L = typeof process < "u" && process.env !== void 0 && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", _e = "active", Pt = "data-styled-version", X = "6.1.15", Zt = `/*!sc*/
`, Et = typeof window < "u" && "HTMLElement" in window, Cr = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" && process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY), Ir = {}, $t = Object.freeze([]), tt = Object.freeze({});
function Jt(t, e, r) {
...
function Fe(t) {
  ...
  f.push(function(d) {
    d.type === At && d.value.includes("&") && (d.props[0] = d.props[0].replace(Hr, r).replace(n, u));
  }), a.prefix && f.push(wr), f.push(yr);
  var l = function(d, g, w, I) {
    g === void 0 && (g = ""), w === void 0 && (w = ""), I === void 0 && (I = "&"), e = I, r = g, n = new RegExp("\\".concat(r, "\\b"), "g");
    var O = d.replace(qr, ""), P = gr(w || g ? "".concat(w, " ").concat(g, " { ").concat(O, " }") : O);
...
var ze = new et(), qt = Fe(), re = R.createContext({ shouldForwardProp: void 0, styleSheet: ze, stylis: qt }), rn = re.Consumer, Kr = R.createContext(void 0);
function _t() {
  return Se(re);
}
function Ur(t) {
...
var Ge = function(t) {
  ...
  for (var s in t) {
    var o = t[s];
    t.hasOwnProperty(s) && !Ge(o) && (Array.isArray(o) && o.isCss || H(o) ? n.push("".concat(me(s), ":"), o, ";") : ut(o) ? n.push.apply(n, Z(Z(["".concat(s, " {")], Le(o), !1), ["}"], !1)) : n.push("".concat(me(s), ": ").concat((e = s, (r = o) == null || typeof r == "boolean" || r === "" ? "" : typeof r != "number" || r === 0 || e in br || e.startsWith("--") ? String(r).trim() : "".concat(r, "px")), ";")));
  }
  return n;
};
function G(t, e, r, n) {
  ...
  if (H(t)) {
    if (!H(o = t) || o.prototype && o.prototype.isReactComponent || !e) return [t];
    var s = t(e);
    return G(s, e, r, n);
  }
  var o;
...
})(), q = R.createContext(void 0), nn = q.Consumer;
function sn() {
  var t = Se(q);
  if (!t) throw k(18);
  return t;
...
function on(t) {
  var e = R.useContext(q), r = yt(function() {
    return (function(n, s) {
      if (!n) throw k(14);
      if (H(n)) {
        var o = n(s);
  ...
  return t.children ? R.createElement(q.Provider, { value: r }, t.children) : null;
}
var Mt = {};
function Qr(t, e, r) {
  ...
  function b(C, _) {
    return (function(y, h, K) {
      var ft = y.attrs, Be = y.componentStyle, He = y.defaultProps, qe = y.foldedComponentIds, Ke = y.styledComponentId, Ue = y.target, Ve = R.useContext(q), Ze = _t(), Nt = y.shouldForwardProp || Ze.shouldForwardProp, se = Jt(h, Ve, He) || tt, D = (function(lt, st, ht) {
        for (var ot, W = x(x({}, st), { className: void 0, theme: ht }), Dt = 0; Dt < lt.length; Dt += 1) {
          var dt = H(ot = lt[Dt]) ? ot(W) : ot;
...
function ne(t) {
  for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
  if (H(t) || ut(t)) return ve(G(ye($t, Z([t], e, !0))));
  var n = t;
...
function an(t) {
  ...
  var n = ne.apply(void 0, Z([t], e, !1)), s = "sc-global-".concat(Qt(JSON.stringify(n))), o = new tn(n, s), a = function(i) {
    var u = _t(), f = R.useContext(q), l = R.useRef(u.styleSheet.allocateGSInstance(s)).current;
...
function un(t) {
  var e = R.forwardRef(function(r, n) {
    var s = Jt(r, R.useContext(q), t.defaultProps);
...
var fn = (function() {
  function t() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (!r) return "";
      var n = Ht(), s = ct([n && 'nonce="'.concat(n, '"'), "".concat(L, '="true"'), "".concat(Pt, '="').concat(X, '"')].filter(Boolean), " ");
      ...
      if (!n) return [];
      var s = ((r = {})[L] = "", r[Pt] = X, r.dangerouslySetInnerHTML = { __html: n }, r), o = Ht();
