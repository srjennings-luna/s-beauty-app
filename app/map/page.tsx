...
export default function MapPage() {
  ...
  return (
    <div className="h-screen bg-[#203545] flex flex-col overflow-hidden">
      {/* Header */}
      <div className="bg-[#1a2a36] border-b border-white/10 px-4 py-3 safe-area-top flex-shrink-0">
      ...
      <div className="bg-[#1a2a36]/50 border-b border-white/10 px-4 py-3 flex-shrink-0">
