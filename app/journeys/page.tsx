      ...
      <div className="min-h-screen bg-[#fdf6e8] pb-28">
        ...
        {error ? (
          ...
          <>
            ...
            {/* Coming soon — themed placeholders for unbuilt founding themes.
                Renders at the bottom of the page, after every populated
                section, so it never sits between Journeys and Episode
                Companions. Only shows themes that have no corresponding
                journey yet. */}
            {(() => {
              ...
              if (comingSoonThemes.length === 0) return null;
              return (
                <div className="px-5">
