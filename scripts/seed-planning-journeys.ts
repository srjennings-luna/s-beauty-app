...
type PlanningItem = {
  ...
  stream: 'journey'
  status: 'idea'
  journeyName: 'three-ways' | 'ootsp' | 'perelandra' | 'ths'
  framework: 'ascent' | 'argument' | 'quest' | 'season' | 'single-mind' | 'discovery'
  contentType?: string
...
function dayItem(
  idSlug: string,
  journeyLabel: string,
  journeyName: PlanningItem['journeyName'],
  framework: PlanningItem['framework'],
  dayNum: number,
  dayTitle: string,
  way: string,
  contentType: string,
